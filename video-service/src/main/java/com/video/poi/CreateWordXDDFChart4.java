...
public class CreateWordXDDFChart4 {
	...
	public static void main(String[] args) throws Exception {
		try (XWPFDocument document = new XWPFDocument()) {
			...
			series2.setTitle("b", setTitleInDataSheet(chart, "b", 1));
			series3.setTitle("c", setTitleInDataSheet(chart, "c", 1));
 

			// plot chart data
			// 设置多个柱子之间的间隔
			chart.getCTChart().getPlotArea().getBarChartArray(0).addNewOverlap().setVal((byte) -20);
